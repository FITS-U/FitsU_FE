...
const RecCard = () => {
  const ctgAndCard = [
    {ctgEng: "food", ctgKo: "식비", totalAmount: "127,900", cardName: "IBK 무민카드", cardCtg: "패스트푸드", discountRate: "60%"},
    {ctgEng: "transport", ctgKo: "교통", totalAmount: "60,000", cardName: "KB 청춘대로 톡톡카드", cardCtg: "대중교통", discountRate: "10%"},
    {ctgEng: "shopping", ctgKo: "쇼핑", totalAmount: "40,300", cardName: "IBK 무민카드", cardCtg: "온라인 쇼핑", discountRate: "20%"}
  ]
